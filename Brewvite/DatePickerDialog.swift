...
class DatePickerDialog: UIView {
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: NSDate = NSDate(), datePickerMode: UIDatePickerMode = .DateAndTime, minuteInterval: Int?, callback: DatePickerCallback) {
        ...
        self.datePicker.minuteInterval = minuteInterval ?? 5
        ...
        UIView.animateWithDuration(
            ...
            animations: { () -> Void in
                self.backgroundColor = UIColor(red: 184, green: 134, blue: 11, alpha: 0.6)
